...
@section('title', 'Sobre — Aliança Consultoria')
@section('meta_description', 'Conheça a Aliança Consultoria e Administração. Especialistas em engenharia, infraestrutura, transporte e meio ambiente. Missão, valores e história.')
...
<section class="relative py-32 overflow-hidden" style="background: radial-gradient(ellipse at bottom right, rgba(218,18,18,0.22) 0%, transparent 50%), linear-gradient(135deg, #000931 0%, #0b0e1a 100%);">
    ...
    <div class="relative max-w-7xl mx-auto px-6 lg:px-20">
        ...
        <div class="flex flex-wrap gap-4 mt-10 reveal-3">
            ...
            <a href="{{ route('servicos') }}" class="btn-outline-light">Ver serviços</a>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-20">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <a href="{{ route('servicos') }}" class="inline-flex items-center gap-2 text-sm font-semibold transition-colors" style="color: rgba(218,18,18,0.85);"
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="card-premium p-6">
                    <p class="font-display font-bold text-4xl mb-1" style="color: #DA1212;">{{ $n['valor'] }}</p>
                    <p class="text-sm" style="color: rgba(238,238,238,0.5);">{{ $n['label'] }}</p>
                </div>
                @endforeach
            </div>
        </div>
...
<section class="py-24 border-b" style="background-color: #0b0e1a; border-color: rgba(80,110,200,0.10);">
    <div class="max-w-7xl mx-auto px-6 lg:px-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="card-premium p-6">
                <span class="text-xs font-bold tracking-widest" style="color: rgba(218,18,18,0.6);">{{ $v['num'] }}</span>
                <h3 class="font-display font-bold text-lg mt-2 mb-3" style="color: #EEEEEE;">{{ $v['nome'] }}</h3>
                <p class="text-sm leading-relaxed" style="color: rgba(238,238,238,0.5);">{{ $v['desc'] }}</p>
            </div>
            @endforeach
        </div>
    </div>
...
<section class="py-28 border-t" style="background: radial-gradient(ellipse at top right, rgba(218,18,18,0.22) 0%, transparent 50%), linear-gradient(135deg, #000931 0%, #080b15 100%); border-color: rgba(218,18,18,0.5);">
    <div class="max-w-7xl mx-auto px-6 lg:px-20 text-center">
        ...
        <div class="flex flex-wrap gap-4 justify-center">
            ...
            <a href="{{ route('clientes') }}" class="btn-outline-light">Ver clientes</a>
        </div>
    </div>
</section>
