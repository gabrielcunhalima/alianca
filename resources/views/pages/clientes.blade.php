...
@section('title', 'Clientes e Cases — Aliança Consultoria')
@section('meta_description', 'ANTT, ArcelorMittal, Santos Brasil e outros. Projetos em portos, ferrovias, mobilidade urbana e meio ambiente em todo o Brasil.')
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-20">
        ...
        <div class="space-y-4">
            ...
            <div class="card-premium overflow-hidden">
                {{-- Header --}}
                <div class="px-8 py-6 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-l-2" style="border-color: rgba(80,110,200,0.14); border-left-color: #DA1212;">
                    <div>
                        <h2 class="font-display font-bold text-2xl" style="color: #EEEEEE;">{{ $c['cliente'] }}</h2>
                        <p class="text-sm mt-1" style="color: rgba(238,238,238,0.4);">{{ $c['nome_completo'] }}</p>
                    </div>
                ...
                {{-- Projetos --}}
                <div>
                    @foreach($c['projetos'] as $p)
                    <div class="px-8 py-5 border-b last:border-0" style="border-color: rgba(80,110,200,0.08);">
                        <p class="font-medium mb-1" style="color: rgba(238,238,238,0.9);">{{ $p['titulo'] }}</p>
                        <p class="text-sm leading-relaxed" style="color: rgba(238,238,238,0.45);">{{ $p['desc'] }}</p>
                    </div>
                    @endforeach
                </div>
            </div>
