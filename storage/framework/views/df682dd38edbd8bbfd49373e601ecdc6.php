<?php $__env->startSection('title', 'Serviços — Aliança Consultoria'); ?>
<?php $__env->startSection('meta_description', 'Estudos de viabilidade, projetos de engenharia, licenciamento ambiental, captação de recursos e licitações públicas. Atuação nacional.'); ?>

<?php $__env->startSection('content'); ?>


<section class="relative py-32 overflow-hidden" style="background: radial-gradient(ellipse at bottom right, rgba(218,18,18,0.22) 0%, transparent 50%), linear-gradient(135deg, #000931 0%, #070a18 100%);">
...
<?php $__currentLoopData = $servicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<section id="<?php echo e($s['id']); ?>" class="py-20 border-b" style="background-color: <?php echo e($i % 2 !== 0 ? '#050810' : '#070a18'); ?>; border-color: rgba(238,238,238,0.06);">
    <div class="max-w-7xl mx-auto px-6 lg:px-20">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
                <span class="text-xs font-semibold uppercase tracking-widest" style="color: rgba(218,18,18,0.8);">0<?php echo e($i + 1); ?></span>
                <h2 class="font-display font-bold text-3xl md:text-4xl mt-3 mb-4 leading-tight" style="color: #EEEEEE;"><?php echo e($s['titulo']); ?></h2>
                <p class="text-lg leading-relaxed mb-6" style="color: rgba(238,238,238,0.55);"><?php echo e($s['intro']); ?></p>
                <a href="<?php echo e(route('contato')); ?>" class="inline-flex items-center gap-2 text-sm font-semibold transition-colors" style="color: rgba(218,18,18,0.85);"
            ...
            <div class="card-premium p-6">
                <ul class="space-y-3">
                    <?php $__currentLoopData = $s['itens']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="flex items-start gap-3 text-sm pb-3 border-b last:border-0 last:pb-0" style="border-color: rgba(238,238,238,0.06); color: rgba(238,238,238,0.7);">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\wamp64\www\alianca\resources\views/pages/servicos.blade.php ENDPATH**/ ?>