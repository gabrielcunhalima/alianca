...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Consultoria especializada em estudos de engenharia, portos, rodovias, ferrovias, meio ambiente e licitações públicas. Atuação nacional.'); ?>">
    <title><?php echo $__env->yieldContent('title', 'Aliança Consultoria — Engenharia, Infraestrutura e Transporte'); ?></title>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-20">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center gap-8">
                    <a href="<?php echo e(route('servicos')); ?>" class="text-sm font-medium transition-colors" style="color: rgba(238,238,238,0.6);" onmouseover="this.style.color='#EEEEEE'" onmouseout="this.style.color='rgba(238,238,238,0.6)'">Serviços</a>
                    <a href="<?php echo e(route('sobre')); ?>" class="text-sm font-medium transition-colors" style="color: rgba(238,238,238,0.6);" onmouseover="this.style.color='#EEEEEE'" onmouseout="this.style.color='rgba(238,238,238,0.6)'">Sobre</a>
                    <a href="<?php echo e(route('clientes')); ?>" class="text-sm font-medium transition-colors" style="color: rgba(238,238,238,0.6);" onmouseover="this.style.color='#EEEEEE'" onmouseout="this.style.color='rgba(238,238,238,0.6)'">Clientes</a>
                    <a href="<?php echo e(route('contato')); ?>" class="btn-accent text-sm">
                        Agendar Consultoria
                    </a>
                </div>
            ...
            <div x-show="mobileMenuOpen" x-transition class="md:hidden border-t py-4 flex flex-col gap-4" style="border-color: rgba(80,110,200,0.14);">
                <a href="<?php echo e(route('servicos')); ?>" class="text-sm font-medium" style="color: rgba(238,238,238,0.7);">Serviços</a>
                <a href="<?php echo e(route('sobre')); ?>" class="text-sm font-medium" style="color: rgba(238,238,238,0.7);">Sobre</a>
                <a href="<?php echo e(route('clientes')); ?>" class="text-sm font-medium" style="color: rgba(238,238,238,0.7);">Clientes</a>
                <a href="<?php echo e(route('contato')); ?>" class="btn-accent text-sm text-center">Agendar Consultoria</a>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-20 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="<?php echo e(route('servicos')); ?>" class="text-sm transition-colors hover:text-white" style="color: rgba(238,238,238,0.4);">Serviços</a></li>
                        <li><a href="<?php echo e(route('sobre')); ?>" class="text-sm transition-colors hover:text-white" style="color: rgba(238,238,238,0.4);">Sobre</a></li>
                        <li><a href="<?php echo e(route('clientes')); ?>" class="text-sm transition-colors hover:text-white" style="color: rgba(238,238,238,0.4);">Clientes</a></li>
                        <li><a href="<?php echo e(route('contato')); ?>" class="text-sm transition-colors hover:text-white" style="color: rgba(238,238,238,0.4);">Contato</a></li>
                    </ul>
                </div>
                <div>
...
<?php /**PATH E:\wamp64\www\alianca\resources\views/layouts/app.blade.php ENDPATH**/ ?>